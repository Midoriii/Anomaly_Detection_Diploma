#!/bin/bash
#PBS -q gpu
#PBS -l select=1:ncpus=1:mem=175gb:ngpus=1:scratch_local=100gb
...
python siamese_network_tester.py -e 90 -m BasicSiameseNetLowerDropout -t BSE -f extended -l contrastive_loss
