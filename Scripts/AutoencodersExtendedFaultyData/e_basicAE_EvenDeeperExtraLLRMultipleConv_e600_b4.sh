#!/bin/bash
#PBS -q gpu
#PBS -l select=1:ncpus=1:mem=18gb:ngpus=1:scratch_local=3gb
...
python autoencoder_tester.py -e 600 -b 4 -m BasicAutoencoderEvenDeeperExtraLLRMultipleConv -f extended
