...
def main():
    ...
    model = load_model("Model_Saves/Detailed/SiameseNetLiteMultipleConv_BSE_e40_b4_detailed")
    ...
    model = load_model("Model_Saves/Detailed/BasicSiameseNet_SE_e20_b4_detailed")
