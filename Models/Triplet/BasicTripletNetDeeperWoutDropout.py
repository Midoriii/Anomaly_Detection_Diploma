...
Basic Triplet Network, slightly deeper and without dropout
'''
import numpy as np
import keras.backend as K

from Models.Triplet.BaseTripletModel import BaseTripletModel
...
class BasicTripletNetDeeperWoutDropout(BaseTripletModel):

    def __init__(self):
        super().__init__()
        self.name = "BasicTripletNetDeeperWithoutDropout"
        self.lr = 0.0001
        return
