'''
Basic Siamese Network, slightly shallower, with multiple convolutions, smaller dense layer
'''
import numpy as np
import keras.backend as K

from Models.BaseSiameseModel import BaseSiameseModel
...
class SiameseNetLiteMultipleConvAltTwo(BaseSiameseModel):

    def __init__(self):
        super().__init__()
        self.name = "SiameseNetLiteMultipleConvAltTwo"
        self.lr = 0.00001
        return
