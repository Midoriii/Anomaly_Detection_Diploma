'''
Basic bigAN net using Average Pooling
'''
...
from keras.layers import UpSampling2D, Conv2D, AveragePooling2D, BatchNormalization, Dropout, LeakyReLU
from keras.models import Model
from keras.optimizers import RMSprop, Adam, SGD



class BasicBiganAVGPool(BaseBiganModel):
