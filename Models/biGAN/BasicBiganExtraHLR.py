'''
Basic bigAN net, with even higher learning rate
'''
...
class BasicBiganExtraHLR(BaseBiganModel):

    def __init__(self, input_shape, latent_dim=24, lr=0.05, w_clip=0.01, batch_size=4):
        super().__init__(input_shape, latent_dim, lr, w_clip, batch_size)
        self.name = "BasicBiganExtraHLR"
