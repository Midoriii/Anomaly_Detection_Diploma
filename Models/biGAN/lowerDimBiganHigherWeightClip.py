'''
Basic bigAN net made to work on 192x192 images and with higher weight clip
'''
...
class lowerDimBiganHigherWeightClip(BaseBiganModel):

    def __init__(self, input_shape, latent_dim=24, lr=0.0005, w_clip=0.1, batch_size=4):
        super().__init__(input_shape, latent_dim, lr, w_clip, batch_size)
        self.name = "lowerDimBiganHigherWeightClip"
    ...
    def build_generator(self):
        ...
        x = Dense(6*6*32, kernel_constraint=WeightClip(self.w_clip))(z_input)
        x = Reshape([6, 6, 32])(x)
