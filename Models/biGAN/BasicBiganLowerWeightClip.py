'''
Basic bigAN net with lower weightclip
'''
...
class BasicBiganLowerWeightClip(BaseBiganModel):

    def __init__(self, input_shape, latent_dim=24, lr=0.00005, w_clip=0.001, batch_size=4):
        super().__init__(input_shape, latent_dim, lr, w_clip, batch_size)
        self.name = "BasicBiganLowerWeightClip"
