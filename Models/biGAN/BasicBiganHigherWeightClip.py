'''
Basic bigAN net with higher weightclip
'''
...
class BasicBiganHigherWeightClip(BaseBiganModel):

    def __init__(self, input_shape, latent_dim=24, lr=0.00005, w_clip=0.1, batch_size=4):
        super().__init__(input_shape, latent_dim, lr, w_clip, batch_size)
        self.name = "BasicBiganHigherWeightClip"
