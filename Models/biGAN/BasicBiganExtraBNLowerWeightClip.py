'''
Basic bigAN net with Batch Norm in G and E and lower weightclip
'''
...
class BasicBiganExtraBNLowerWeightClip(BaseBiganModel):
    ...
    def __init__(self, input_shape, latent_dim=24, lr=0.0005, w_clip=0.001, batch_size=4):
        ...
        self.name = "BasicBiganExtraBNLowerWeightClip"
