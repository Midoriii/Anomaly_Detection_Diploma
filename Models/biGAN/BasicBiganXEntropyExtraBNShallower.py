'''
Basic bigAN net, using cross entropy as loss and with extra BatchNorm in G and E
and shallower architecture
'''
import numpy as np
...
class BasicBiganXEntropyExtraBNShallower(BaseBiganModel):
    ...
    def __init__(self, input_shape, latent_dim=48, lr=0.0005, w_clip=0.01, batch_size=4):
        ...
        self.name = "BasicBiganXEntropyExtraBNShallower"
