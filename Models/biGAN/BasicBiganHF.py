'''
Basic bigAN net with higher filter count
'''
...
class BasicBiganHF(BaseBiganModel):
    ...
    def build_generator(self):
        ...
        x = Dense(6*6*64, kernel_constraint=WeightClip(self.w_clip))(z_input)
        x = Reshape([6, 6, 64])(x)
