...
Basic Variational Autoencoder, slightly deeper with lowered learning rate
'''
import numpy as np
...
class BasicVAEDeeper_LLR(BaseVAEModel):

    def __init__(self, input_shape, latent_dim=12, lr=0.00005):
        super().__init__(input_shape, latent_dim, lr)

        self.name = "BasicVAEDeeper_LLR"
