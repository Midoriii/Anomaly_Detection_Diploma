...
Basic Variational Autoencoder with even higher latent dim
'''
import numpy as np
...
class BasicVAE_ExtraHiLatDim(BaseVAEModel):

    def __init__(self, input_shape, latent_dim=48, lr=0.0005):
        super().__init__(input_shape, latent_dim, lr)

        self.name = "BasicVAE_ExtraHiLatDim"
