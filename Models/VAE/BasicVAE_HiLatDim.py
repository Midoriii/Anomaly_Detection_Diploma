'''
Basic Variational Autoencoder with higher latent dim
'''
import numpy as np
...
class BasicVAE_HiLatDim(BaseVAEModel):

    def __init__(self, input_shape, latent_dim=24, lr=0.0005):
        super().__init__(input_shape, latent_dim, lr)

        self.name = "BasicVAE_HiLatDim"
