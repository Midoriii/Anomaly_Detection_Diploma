'''
Basic Variational Autoencoder with lower latent dim and lowered learning ratw
'''
import numpy as np
...
class BasicVAE_LowLatDim_LLR(BaseVAEModel):

    def __init__(self, input_shape, latent_dim=6, lr=0.00005):
        super().__init__(input_shape, latent_dim, lr)

        self.name = "BasicVAE_LowLatDim_LLR"
