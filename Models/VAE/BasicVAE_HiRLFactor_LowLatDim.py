...
Basic Variational Autoencoder with higher reconstruction loss factor
and lower latent dims
'''
import numpy as np
...
class BasicVAE_HiRLFactor_LowLatDim(BaseVAEModel):

    def __init__(self, input_shape, latent_dim=6, lr=0.0005):
        super().__init__(input_shape, latent_dim, lr)

        self.name = "BasicVAE_HiRLFactor_LowLatDim"

        self.optimizer = Adam(lr=self.lr)
        self.filters = 64

        self.rl_factor = 10000
