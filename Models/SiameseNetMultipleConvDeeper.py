'''
Deeper Siamese Net based on the basic one, with multiple convolutions per layer
'''
import numpy as np
...
class SiameseNetMultipleConvDeeper(BaseSiameseModel):

    def __init__(self):
        super().__init__()
        self.name = "SiameseNetMultipleConvDeeper"
        self.lr = 0.00001
        return
