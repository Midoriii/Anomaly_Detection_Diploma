...
def main():
    ...
    model = load_model("Model_Saves/Detailed/low_dim_BasicTripletNetWithoutDropout_BSE_set_1_e60_b4_detailed", compile=False)
    ...
    model = load_model("Model_Saves/Detailed/low_dim_BasicTripletNetWithoutDropout_SE_set_1_e60_b4_detailed", compile=False)
    #model = load_model("Model_Saves/Detailed/low_dim_BasicTripletNetHFWithoutDropout_SE_set_1_e60_b4_detailed", compile=False)
